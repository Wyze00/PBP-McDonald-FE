...
export default function CustomerPayAtMachine(): React.JSX.Element {
    const [orderNumber, setOrderNumber] = useState<string | null>(null);
    const [loading, setLoading] = useState(false);
    
    // Modal & Payment States
    const [showPaymentModal, setShowPaymentModal] = useState(false);
    const [selectedPayment, setSelectedPayment] = useState<'QRIS' | 'CARD' | null>(null);
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center p-4 text-center bg-gray-50">
                    ...
                    <div className="bg-white rounded-[2rem] w-full max-w-md p-8 shadow-2xl">
                        ...
                        <div className="space-y-4 mb-8">
                            {['QRIS', 'CARD'].map((method) => (
                                <button
                                    key={method}
                                    onClick={() => setSelectedPayment(method as 'QRIS' | 'CARD')}
            ...
            <div className="bg-white p-16 rounded-[2rem] shadow-xl w-full max-w-2xl border border-gray-100 flex flex-col items-center">
                ...
                <div className="text-9xl font-black text-[#DA291C] mb-8">{orderNumber || '--'}</div>
                <p className="text-lg font-bold text-gray-500 max-w-xs mx-auto leading-relaxed mb-8">
                    Please Take The Printed Order Details and Wait For Your Order To Be Served
                </p>
